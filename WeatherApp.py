...
def get_weather(city):
    weather_key = "8191cf808cae7f6f0b2f8e40579afb45"
...
def open_image(icon):
    ...
    image_url = os.path.join(os.path.sep, os.getcwd(), "icons", icon)
    print("AAAAAAAAAAAAAAAAA" + image_url)
    img = ImageTk.PhotoImage(Image.open(image_url + '@2x'+ '.png').resize((size, size)))
